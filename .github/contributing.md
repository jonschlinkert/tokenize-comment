# Contributing to tokenize-comment

First and foremost, thank you! We appreciate that you want to contribute to tokenize-comment, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for tokenize-comment**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for tokenize-comment:

- star the [project](https://github.com/jonschlinkert/tokenize-comment)
- tweet your support for tokenize-comment
...
- **version**: please note the version of tokenize-comment are you using
...
[so]: http://stackoverflow.com/questions/tagged/tokenize-comment